<?php
namespace Drupal\kibo_sdk_proxy\Mozu\Api\Utilities;

use Drupal\kibo_sdk_proxy\Mozu\Api\ApiException;
use Drupal\kibo_sdk_proxy\Mozu\Api\iApiContext;
/**
 * HttpHelper
 *
...
class HttpHelper {
     ...
     * @throws \Drupal\kibo_sdk_proxy\Mozu\Api\ApiException
     * @throws ApiException
     */
            ...
            case "GuzzleHttp\Exception\RequestException":
                ...
                if (!empty($jsonResponse)) {
                    if (isset($jsonResponse->message))
                        ...
                        $apiException = new ApiException($e->getResponse()->getReasonPhrase().", inspect Drupal\kibo_sdk_proxy\Mozu\Api\ApiException->items property for more details", $code);
