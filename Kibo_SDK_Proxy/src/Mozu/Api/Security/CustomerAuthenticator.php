...
use Drupal\kibo_sdk_proxy\Mozu\Api\Contracts\Customer\CustomerUserAuthInfo;
use Drupal\kibo_sdk_proxy\Mozu\Api\Headers;
use Drupal\kibo_sdk_proxy\Mozu\Api\Resources\Platform\TenantResource;
use Drupal\kibo_sdk_proxy\Mozu\Api\Urls\Commerce\Customer\CustomerAuthTicketUrl;
...
class CustomerAuthenticator {
	public static function ensureAuthTicket($authTicket)
	{
		...
		if ($dateTimeNow >= $authTicket->accessTokenExpiration)
	...
	public static function refreshUserAuthTicket($authTicket)
	{
		try {
