<?php
namespace Drupal\acf_kibo\Mozu\Api\Utilities;

use Drupal\acf_kibo\Mozu\Api\ApiException;
use Drupal\acf_kibo\Mozu\Api\iApiContext;
/**
 * HttpHelper
 *
...
class HttpHelper {
     ...
     * @throws \Drupal\acf_kibo\Mozu\Api\ApiException
     * @throws ApiException
     */
            ...
            case "GuzzleHttp\Exception\RequestException":
                ...
                if (!empty($jsonResponse)) {
                    if (isset($jsonResponse->message))
                        ...
                        $apiException = new ApiException($e->getResponse()->getReasonPhrase().", inspect Drupal\acf_kibo\Mozu\Api\ApiException->items property for more details", $code);
